...
namespace SPMeta2.Docs.ProvisionSamples.Provision.Definitions
{
    ...
    public class WebPartDefinitionTests : ProvisionTestBase
    {
        ...
        [SampleMetadata(
          Title = "Adding web part by type (SSOM)",
          Description = "",
          Order = 10,
          CatagoryAlias = SampleCategory.SharePointFoundation,
          GroupAlias = SampleGroups.WebParts)]
        ...
        [TestCategory("Docs.WebPartDefinition")]
        [SampleMetadata(
          Title = "Adding web part by file name",
          Description = "",
          Order = 30,
          CatagoryAlias = SampleCategory.SharePointFoundation,
          GroupAlias = SampleGroups.WebParts)]
        ...
        [TestCategory("Docs.WebPartDefinition")]
        [SampleMetadata(
          Title = "Preprocessing web par XML",
          Description = "",
          Order = 40,
          CatagoryAlias = SampleCategory.SharePointFoundation,
          GroupAlias = SampleGroups.WebParts)]
