...
<a href="_samples/Models-SettingUpSiteModels.sample-ref">setting up site model</a>

#### Setting up a web model
<a href="_samples/Models-SettingUpWebModels.sample-ref">setting up web model</a>
